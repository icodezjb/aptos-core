...
impl serde::Serialize for CollectionData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("aptos.token_output.v1.CollectionData", len)?;
        if !self.creator_address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CollectionData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct(
            "aptos.token_output.v1.CollectionData",
            FIELDS,
            GeneratedVisitor,
        )
    }
...
impl serde::Serialize for TokenDataId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser =
            serializer.serialize_struct("aptos.token_output.v1.TokenDataId", len)?;
        if !self.creator_address.is_empty() {
            struct_ser.serialize_field("creatorAddress", &self.creator_address)?;
        }
        if !self.collection_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TokenDataId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.TokenDataId")
            }
        ...
        deserializer.deserialize_struct(
            "aptos.token_output.v1.TokenDataId",
            FIELDS,
            GeneratedVisitor,
        )
    }
...
impl serde::Serialize for TokenId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.token_output.v1.TokenId", len)?;
        if let Some(v) = self.token_data_id.as_ref() {
            struct_ser.serialize_field("tokenDataId", v)?;
        }
        if self.property_version != 0 {
...
impl<'de> serde::Deserialize<'de> for TokenId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.token_output.v1.TokenId")
            }
        ...
        deserializer.deserialize_struct("aptos.token_output.v1.TokenId", FIELDS, GeneratedVisitor)
    }
}
